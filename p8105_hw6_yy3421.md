...
<img src="p8105_hw6_yy3421_files/figure-gfm/distribution-1.png" width="90%" />
...
cv_df = 
  cv_df |> 
  mutate(
    mod_1 = map(train, \(df) lm(bwt ~ blength + babysex + malform, data = df)),
...
<img src="p8105_hw6_yy3421_files/figure-gfm/unnamed-chunk-6-1.png" width="90%" />
