...
The distribution for R.Squared and Log(β1*β2) are plotted below. We can observe a tail for smaller estimates for both two quantities, with a heavier tail for estimates of R.squared.
